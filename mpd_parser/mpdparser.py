...
df['prob'] = prob.reshape(prob.shape[0]*prob.shape[1])[4200:4200+bandwidth.size]
df['true'] = true_prob.reshape(prob.shape[0]*prob.shape[1])[4200:4200+bandwidth.size]
...
# in viewport
ax1.boxplot([achieved_quality*df["true"], best_quality*df["true"]])
